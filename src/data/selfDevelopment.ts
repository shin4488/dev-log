...
webサイト版同様に財務データの自動切り替え機能をつけて、操作性を上げた。`,
    summary:
      '株探やYahoo!ファイナンスと併用して企業財務を素早く確認。財務データ自動切替で操作しやすい。',
    technicalAppeal:
      '財務データを自動で切り替え、検索した企業の情報を拡張機能側に即表示。',
  },
  {
...
フロントエンドとバックエンドのインターフェースにはGraphQLを使用した。`,
    summary:
      '公開済み財務データをグラフ化し一覧表示。株探リンクで株価も確認可能。自動切替と検索機能、GraphQL活用。',
    technicalAppeal:
      '財務3表を自動切替し訂正データも反映。GraphQLで必要なデータだけ取得。',
  },
  {
    title:
...
としたことで、リアルタイムの処理負担が減り、投稿取得のサーバサイドの処理時間が1秒ほど短縮した。`,
    summary:
      '福井の優良企業を共有するサービス。認知拡大が課題だが、画像取得をバッチ化し負荷軽減。',
    technicalAppeal: '企業ロゴ画像を日次バッチで取得・保存し表示速度を向上。',
  },
  {
...
「バットとボール」「ボールと盤」などの当たり判定には、三角関数やベクトルを利用してより厳密な当たり判定を行うようにした。`,
    summary:
      '常に満塁スタートの野球ゲーム。ランキングで競えるほか、数学的当たり判定で遊びごたえ。',
    technicalAppeal: '三角関数やベクトルを使った精密な当たり判定を実装。',
  },
  {
...
順位表を教えてくれるようになっており、比較的気軽に使える。`,
    summary: '試合日の順位表を自動投稿。フォローするだけで最新順位が届く。',
    technicalAppeal: 'フォローするだけで最新順位を受け取れる手軽さを実現。',
  },
  {
    title:
...
（GAS側でAPIのエンドポイントを公開できるため、自作したGASの翻訳用のAPIを叩いている。）`,
    summary:
      '位置情報からトイレ付きコンビニを検索し、画像文字の翻訳も可能。GAS利用で翻訳は無料。',
    technicalAppeal: '翻訳処理をGASで実装し、APIコストを抑えて運用。',
  },
  {
    title: 'Shooting Game',
...
クオリティ的な問題はたくさんあると思うが、当時は結構真剣に作っていた。`,
    ...
    summary: '1分間弾を避け続けるシンプルなゲーム。Renderで無料デプロイ。',
    technicalAppeal: 'Renderで無料ホスティングし手軽に遊べる。',
  },
];
